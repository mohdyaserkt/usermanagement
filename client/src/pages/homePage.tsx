...
export const AdminTab = () => {
  ...
  return (
    <div className="md:flex p-10 min-h-screen bg-[#111827]">
      <ul className="flex-column space-y space-y-4 text-sm font-medium text-gray-500 dark:text-gray-400 md:me-4 mb-4 md:mb-0  ">
        
        <li onClick={()=>setcategory("dash")}>
          <a
            href="#"
        ...
        <li>
        <button  onClick={logOut} type="button" className="text-red-700 m-3  hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-11 py-2.5 text-center me-2 mb-2 dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900">Logout</button>
        </li>
        
      </ul>
      <div className="h-screen  overflow-scroll  p-6 bg-gray-50 text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-full">
